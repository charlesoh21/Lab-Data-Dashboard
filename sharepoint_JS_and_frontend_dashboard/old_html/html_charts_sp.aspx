...
<html lang="en">
  <head>
    ...
    <!-- simplebar CSS-->
    <link href="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/plugins/simplebar/css/simplebar.css" rel="stylesheet"/>
    <!-- Bootstrap core CSS-->
    <link href="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/css/bootstrap.min.css" rel="stylesheet"/>
    <!-- animate CSS-->
    <link href="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/css/animate.css" rel="stylesheet" type="text/css"/>
    <!-- Icons CSS-->
    <link href="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/css/icons.css" rel="stylesheet" type="text/css"/>
    <!-- Sidebar CSS-->
    <link href="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/css/sidebar-menu.css" rel="stylesheet"/>
    <!-- Custom Style-->
    <link href="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/css/app-style.css" rel="stylesheet"/>
  ...
  <body class="bg-theme">
    ...
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/js/listImporter.js"></script>
    <script src="https://code.jquery.com/jquery-2.2.4.js" type="text/javascript"></script>

    <!-- Bootstrap core JavaScript-->
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/jquery.min.js"></script>
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/popper.min.js"></script>
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/bootstrap.min.js"></script>

    <!-- simplebar js -->
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/plugins/simplebar/js/simplebar.js"></script>

    <!-- sidebar-menu js -->
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/sidebar-menu.js"></script>

    <!-- Custom scripts -->
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/app-script.js"></script>

    <!-- Index js -->
    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/index.js"></script>

    <script src="http://mysite.ssi.samsung.com/personal/Test-TEC-QA-Aging-Logs/SiteAssets/Project_FrontEnd/assets/js/palette.js"></script>
